...
{% block main %}
<section class="padded-h pure-g">

  <div class="justified padded pure-u-1 pure-u-md-1-2 pure-u-lg-1-3">
    <div>
    ...
    <div>
      ...
      <div class="centered padded-v">
        ...
        &amp;
        <a href="https://pola-rs.github.io/polars/py-polars/html/reference/">API Reference</a>
      </div>
    </div>
  </div>
  ...
  <div class="justified padded pure-u-1 pure-u-md-1-2 pure-u-lg-1-3">
    ...
    <div>
      ...
      <div class="centered padded-v">
        <a href="https://pola-rs.github.io/polars-book/user-guide/">User Guide</a>
        &amp;
        <a href="https://pola-rs.github.io/polars/polars/">API Reference</a>
      </div>
    </div>
  </div>
  ...
  <div class="justified padded pure-u-1 pure-u-md-1-2 pure-u-lg-1-3">
    <div>
      ...
      <p>
        ...
        <a href="https://github.com/jorgecarleitao/arrow2">safe Arrow2 implementation</a>
        of the
        <a href="https://arrow.apache.org/docs/format/Columnar.html">Apache Arrow specification</a>,
...
<section class="padded pure-g ribbon">
...
<section class="padded">
  <h2 class="centered">Quickstart</h2>
  <div class="pure-g">
    <div class="padded-h pure-u-1 pure-u-lg-1-2">
...
<section class="padded">
  <div class="pure-g">
    <div class="centered padded-h pure-u-1 pure-u-lg-3-5">
      <h3><i class="fas fa-user-astronaut"></i>Contributors</h3>
      <div id="contributors"></div>
    </div>
    <div class="centered padded-h pure-u-1 pure-u-lg-2-5">
      <h3><i class="fas fa-life-ring"></i>Sponsors</h3>
      <p>
        <a href="https://www.xomnia.com/">
          <img
